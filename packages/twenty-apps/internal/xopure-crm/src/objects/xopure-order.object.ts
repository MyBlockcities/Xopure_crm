...
export const XOPURE_ORDER_TOTAL_FIELD_ID = 'e4954e0b-e7c4-409e-9532-3b3a8461d345';
export const XOPURE_ORDER_ORDERED_AT_FIELD_ID = '97910878-6e68-4bd4-8de1-bd03aaae7b08';
...
export default defineObject({
  ...
  fields: [
    ...
    { universalIdentifier: XOPURE_ORDER_TOTAL_FIELD_ID, type: FieldType.NUMBER, name: 'orderTotal', label: 'Order total', icon: 'IconCurrencyDollar', defaultValue: 0 },
    { universalIdentifier: XOPURE_ORDER_ORDERED_AT_FIELD_ID, type: FieldType.DATE_TIME, name: 'orderedAt', label: 'Ordered at', icon: 'IconCalendar', isNullable: true, defaultValue: null },
