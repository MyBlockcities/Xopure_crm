...
import { XOPURE_AMBASSADOR_NAME_FIELD_ID, XOPURE_AMBASSADOR_OBJECT_ID, XOPURE_AMBASSADOR_PAID_AS_RANK_FIELD_ID, XOPURE_AMBASSADOR_STATUS_FIELD_ID } from '../objects/xopure-ambassador.object';
...
export default defineView({
  ...
  fields: [
    ...
    { universalIdentifier: '088dd3a4-92e7-4f9e-a875-cb36e2ec0e23', fieldMetadataUniversalIdentifier: XOPURE_AMBASSADOR_PAID_AS_RANK_FIELD_ID, position: 1, isVisible: true, size: 160 },
