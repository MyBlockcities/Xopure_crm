...
- [Current XO Pure customization inventory](../../../../docs/xopure-customization-inventory-2026-06-02.md)
...
- Installed XO Pure Mission Control page layout with native CRM charts, record tables, and live cards
...
- Read-only Supabase Realtime dashboard counter, order activity feed, and revenue trend using
  an RLS-scoped anon key
