...
const product = {
  ...
  fields: [
    ...
    { name: 'isActive', label: 'Is Active', type: 'BOOLEAN', icon: 'IconToggleRight', defaultValue: 'true' },
    { name: 'commissionEligible', label: 'Commission Eligible', type: 'BOOLEAN', icon: 'IconCoin', defaultValue: 'true' },
...
const order = {
  ...
  fields: [
    ...
    { name: 'quantity', label: 'Quantity', type: 'NUMBER', icon: 'IconStack', defaultValue: '1' },
